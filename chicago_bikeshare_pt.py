...
def column_to_list(data, index):
    """
    Transforma os itens de uma determinada coluna de uma lista em outra lista.
    Argumentos:
      data: Lista original.
      index: Coluna da lista original que sera transformada em uma outra lista.
    Retorna:
      Uma lista de com os valores da coluna index.
    """
    column_list = []
...
def count_gender(data_list):
    """
    Retorna a quantidade de cada genero [Male, Female].
    Argumentos:
...
def count_user_type(data_list):
    """
    Retorna a quantidade de cada tipo de usuario ['Custumer', 'Subscriber'].
    Argumentos:
      data_list: Lista de tipos de cliente.
    Retorna:
...
def most_popular_gender(data_list):
    """
    Retorna o genero mais popular da lista recebida como parametro.
    Argumentos:
      data_list: Lista de generos.
    Retorna:
...
answer = "Porque existem registros onde o gênero não foi informado."
...
def count_items(column_list):
    """
    Realiza a contagem dos tipos de usuários sem definir previamente os tipos.
    Argumentos:
      column_list: Lista de tipos de usuários.
    Retorna:
      Retorna a lista de tipos de usuarios e sua respectiva quantidade.
    """
